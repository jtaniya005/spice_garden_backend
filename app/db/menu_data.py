MENU = [
    ...
    {"id": 24, "name": "Veg Spring Onion Noodles",  "category": "chinese",     "price": 229, "description": "Soft noodles tossed with spring onion and a light soy glaze.", "tags": ["veg"], "spice": 2},
    ...
    {"id": 27, "name": "Honey Chilli Broccoli",     "category": "chinese",     "price": 239, "description": "Crunchy broccoli glazed in sweet and spicy honey-chilli dressing.", "tags": ["veg", "special"], "spice": 2},
    ...
    {"id": 29, "name": "Hot and Sour Soup",         "category": "continental", "price": 179, "description": "Classic hot and sour broth with mushrooms and vegetables.", "tags": ["veg"], "spice": 2},
    ...
    {"id": 31, "name": "Creamy Tomato Basil Pasta", "category": "continental", "price": 329, "description": "Penne in a velvety tomato-basil cream sauce.", "tags": ["veg"], "spice": 1},
    ...
    {"id": 33, "name": "Spinach Ricotta Cannelloni","category": "continental", "price": 349, "description": "Pasta tubes stuffed with spinach and ricotta, baked in tomato sauce.", "tags": ["veg"], "spice": 0},
    {"id": 34, "name": "Mushroom Truffle Pizza",    "category": "continental", "price": 399, "description": "Thin crust pizza with mushrooms, truffle oil, and mozzarella.", "tags": ["veg", "special"], "spice": 0},
    ...
    {"id": 62, "name": "Paneer Tikka",              "category": "appetizers",  "price": 219, "description": "Marinated paneer grilled with bell peppers and onions.", "tags": ["veg", "special"], "spice": 2},
    ...
    {"id": 91, "name": "Spinach & Pomegranate",     "category": "salads",      "price": 179, "description": "Fresh spinach with pomegranate seeds and walnut dressing.", "tags": ["veg", "special"], "spice": 0},
    ...
    {"id": 14, "name": "Chocolate Lava Cake",       "category": "desserts",    "price": 179, "description": "Warm fondant with a gooey molten centre and vanilla ice cream.", "tags": ["veg"], "spice": 0},
    ...
    {"id": 41, "name": "Brownie Sundae",            "category": "desserts",    "price": 189, "description": "Warm chocolate brownie with vanilla ice cream and nuts.", "tags": ["veg", "special"], "spice": 0},
    ...
    {"id": 99, "name": "Paneer Jalebi",             "category": "desserts",    "price": 149, "description": "Sweet paneer strands in sugar syrup.", "tags": ["veg"], "spice": 0},
    # Drinks
